...
angular_roll = np.diff(running_data['roll']) / dt
angular_pitch = np.diff(running_data['pitch']) / dt
angular_yaw = np.diff(running_data['yaw']) / dt
...
angular_vmag_data['Environment'] = 'Running'
angular_vmag_data.to_csv('running/running_angular_vmag_data.csv', index=False)
